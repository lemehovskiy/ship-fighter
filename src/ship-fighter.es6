/*
 ...
 Repo: https://github.com/lemehovskiy/ship-fighter
 */
...
(function ($) {
    ...
    class ShipFighter {
        ...
        constructor(element, options) {
            ...
            self.data_options = self.$element.data('ship-fighter');
    ...
    $.fn.shipFighter = function() {
        ...
        for (i = 0; i < length; i++) {
            if (typeof opt == 'object' || typeof opt == 'undefined')
                $this[i].ship_fighter = new ShipFighter($this[i], opt);
        else
            ret = $this[i].ship_fighter[opt].apply($this[i].ship_fighter, args);
